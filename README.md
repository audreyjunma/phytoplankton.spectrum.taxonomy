...
1. Downloaded files from Soja-Wozniak Figshare, which are publicly accessible (but you need to download them yourself and insert them in your working directory).
   **LINK TO FIGSHARE:** https://figshare.com/s/abe54f20cd0165596170
3. Jupyter Notebook
4. Relevant Python Libraries, especially icepyx and argopy (see notebook)
